...
const projects = [
  ...
  },
  {
    ...
    description: 'AI-based language learning platform with personalized progress tracking.',
    tech: ['React', 'AI', 'Node.js'],
    highlights: [
      { icon: '🗣️', text: 'Language Learning' },
      { icon: '📈', text: 'Progress Tracking' },
      { icon: '🤖', text: 'AI Assistant' },
      { icon: '📱', text: 'Responsive UI' },
    ],
    live:   'https://nri-language-learning.vercel.app',
    github: 'https://github.com/nirmal192421215',
    image:  '/projects/language_learning.png',
    accent: '#10B981',
    badge:  'LIVE',
    status: 'Live',
    client: true,
  ...
  },
  {
    id: 4,
    title: 'HappyDental',
    subtitle: 'AI Dental Game App',
    description: 'Gamified pediatric dental platform with 20 interactive games, AI assistant, and role-based dashboards.',
    tech: ['React', 'Game Engine', 'AI'],
    highlights: [
      { icon: '🎮', text: '20 Interactive Games' },
      { icon: '🤖', text: 'AI Assistant' },
      { icon: '📊', text: 'Role-based Dashboards' },
      { icon: '🦷', text: 'Pediatric Focus' },
    ],
    live:   'https://dental-eight-ochre.vercel.app',
    github: 'https://github.com/nirmal192421215',
    image:  '/projects/happy_dental.png',
    accent: '#F59E0B',
    badge:  'LIVE',
    status: 'Live',
    client: true,
  ...
  },
  {
    ...
    description: 'Modern travel booking platform with vehicle rentals, tour packages, and WhatsApp booking.',
    tech: ['React', 'Node.js', 'Vite'],
    highlights: [
      { icon: '🚗', text: 'Vehicle Rentals' },
      { icon: '🗺️', text: 'Tour Packages' },
      { icon: '💬', text: 'WhatsApp Booking' },
      { icon: '✈️', text: 'Modern Platform' },
    ],
    live:   'https://dnd-travels.vercel.app',
    github: 'https://github.com/nirmal192421215',
    image:  '/projects/dnd_travels.png',
    accent: '#3B82F6',
    badge:  'LIVE',
    status: 'Live',
    demo: true,
  ...
  },
  {
    ...
    subtitle: 'Responsive Restaurant UI',
    description: 'Responsive restaurant website with a modern UI.',
    tech: ['React', 'CSS', 'Vite'],
    highlights: [
      { icon: '🍔', text: 'Modern UI' },
      { icon: '📱', text: 'Responsive Design' },
      { icon: '🚀', text: 'Fast Performance' },
      { icon: '🎨', text: 'Clean Aesthetics' },
    ],
    live:   'https://restaurant-nk.vercel.app',
    github: 'https://github.com/nirmal192421215',
  ...
  },
  {
    ...
    description: 'Event registration and management platform for colleges.',
    tech: ['React', 'Node.js', 'Express'],
    highlights: [
      { icon: '📅', text: 'Event Registration' },
      { icon: '🏫', text: 'College Platform' },
      { icon: '👥', text: 'User Management' },
      { icon: '🎫', text: 'Ticketing' },
    ],
    live:   'https://collage-event-management-peach.vercel.app',
    github: 'https://github.com/nirmal192421215',
    image:  '/projects/college_event.png',
    accent: '#EC4899',
    badge:  'LIVE',
    status: 'Live',
    client: true,
